        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocailLink = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorSocial", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthorSocial_Authors_AuthorId",
                        column: x => x.AuthorId,
